...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    setTimeout(() => {
      document.cookie = "auth-token=google-demo-token; path=/";
      router.push("/dashboard");
    }, 1500);
  };
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className="flex justify-center mb-4">
            <div className="bg-teal-600 p-2.5 sm:p-3 rounded-full">
          ...
          <CardDescription className="text-slate-600">
            Digitaliza tus tickets y facturas de forma inteligente
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="border-slate-300 focus:border-teal-500 pr-10"
                />
                <Button
                  type="button"
                  variant="ghost"
